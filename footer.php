...
.text-secondary	 { color: var(--bs-secoundary) !important;}
...
/*fix image height for cat,post,tag connections */
  ...
  .dropdown-item:hover, .dropdown-item.active, .dropdown-item:active { color: #fff  !important; background-color: <?php $Color = get_field('Color', 2); if ($Color) echo esc_html($Color); ?> !important; }
...
/** isotop **/
  ...
  .animate-hover:hover .read-more-arrow {
