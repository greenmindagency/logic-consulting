<?php get_header(); // This fxn gets the header.php file and renders it ?>
    ...
    <div data-jarallax data-speed="0.2"  class="bg-primary jarallax">
   ...
   ?> 
    ...
    <h1 class="fw-bold card-title display-4">Search Results</h1>
    <h2 class="mb-4 fw-bold text-uppercase">Get all relevant results for your query</h2>
</div>
